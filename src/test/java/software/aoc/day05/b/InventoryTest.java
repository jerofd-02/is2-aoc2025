...
public class InventoryTest {
    ...
    private static final String rangesOnly = """
            3-5
            10-14
            16-20
            12-18
    ...
    @Test
    public void count_total_fresh_ids_merging_overlapping_ranges() {
        Inventory inventory = Inventory.from(rangesOnly);

        assertThat(inventory.totalFreshIngredientsIds()).isEqualTo(14);
    }
    ...
    public void answer() throws IOException {
        try (InputStream inputStream = Inventory.class.getResourceAsStream("/day05/input.txt")) {
            ...
            assertThat(inventory.totalFreshIngredientsIds()).isEqualTo(357674099117260L);
        }
    }
}
